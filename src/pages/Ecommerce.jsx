    ...
    <div>
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item) => (
            <div
              key={item.title}
              className={`bg-white w-44 dark:text-gray-200 dark:bg-secondary-dark-bg ${
                activeMenu ? "md:w-44" : "md:w-56"
        ...
        <div>
          ...
          <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl md:w-400 p-8 m-3 flex justify-center items-center gap-10">
            <div>
              ...
              <p className="text-gray-400">Yearly seles</p>
            </div>
            <div className="w-40">
              <Pie
                id="pie-chart"
      ...
      <div className="flex flex-wrap justify-center">
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <p
            className="text-xs cursor-pointer hover:drop-shadow-xl font-semibold rounded-lg w-24 py-0.5 px-2 text-gray-200 mt-10"
            style={{ backgroundColor: currentColor }}
          >
            16 APR, 2021
          </p>
        ...
        <div className="w-400 bg-white dark:text-gray-200 dark:bg-secondary-dark-bg rounded-2xl p-6 m-3">
          ...
          <div className="mt-10">
            ...
            <div className="mt-8">
              <p className="font-semibold text-lg">React 18 coming soom!</p>
              <p className="text-gray-400">By Chanyut Dongthana</p>
              <p className="mt-8 text-sm text-gray-400">
                This will be small description foe the news you have shown here.
                There could be some grat info.
              </p>
              <div className="mt-3">
                <Button
                  color="white"
